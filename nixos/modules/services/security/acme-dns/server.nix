      ...
      type = types.submodule {
        options = {
          ...
          nsname = mkOption {
            ...
            '';
            default = null;
            defaultText = "config.services.acme-dns.server.general.domain";
            example = "acme-dns.example.com";
          };
    ...
    assertions = [
      {
        ...
        message = ''
          Option services.acme-dns.server.general.nsadmin should
          contain a valid DNS SOA RNAME-format email address with the
          "@" replaced with ".".
        '';
      }
    ];
